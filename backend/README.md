...
## Project Structure
    ...
    ├── testapiautodatamod_114190  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_114190`
...
2. Clone this repo and `cd testapiautodatamod_114190`
